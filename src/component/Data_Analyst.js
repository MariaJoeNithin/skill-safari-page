...
import { DataAnalytics_JSON } from "../component_src/DataAnalytics_keyValues";
    ...
    <div>
      <div className=" max-w-screen-xl mx-auto p-10 grid grid-cols-1 xl2:grid-cols-2 mt-[40px] gap-10 ">
        <div className="flex flex-col gap-1 xl2:w-full lg:w-[85%] md:w-[95%] mx-auto ">
          <div className="font-[500] md:text-[62px] text-[55px] text-[#212529] lg:leading-[80px] leading-[60px] md:text-left text-center">
            {DataAnalytics_JSON.HomeScreenComponent.left.content_1}
          </div>
          <div className="font-[400] md:text-[16px] text-[#555555] mt-10 text-justify ">
            {DataAnalytics_JSON.HomeScreenComponent.left.content_2}
          </div>
          <button className="text-white px-8 py-3 rounded bg-[#F3274F] font-[600] w-fit text-[18px] underline mt-5">
            {DataAnalytics_JSON.HomeScreenComponent.left.content_3}
          </button>
        </div>
        <div className=" relative xl2:w-auto w-fit mx-auto">
          <img
            src={DataAnalytics_JSON.HomeScreenComponent.right.image_src}
            width={"900px"}
            alt=""
          />
          <div className=" bg-[#FFFFFF] xl2:w-[355px] sm:w-[350px] sm:bottom-[10%] bottom-[-120px] w-[100%] text-[#868686] p-4 rounded-xl border-2 absolute">
            "{DataAnalytics_JSON.HomeScreenComponent.right.thoughts}"
            <div className="flex items-center text-[#fb8c00] my-1">
              ...
              <span className="text-black ml-3">
                {DataAnalytics_JSON.HomeScreenComponent.right.rating}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center flex-col gap-10 sm:mt-[40px] mt-[150px]">
        <div className="text-center font-[600] text-[28px] text-[#212529]">
          {DataAnalytics_JSON.What_You_Will_Learn.title}
        </div>
        <div className="flex flex-wrap items-center md:gap-3 gap-8 md:justify-center justify-start px-5 w-[90%] mx-auto">
          <div className="flex items-center font-[500] text-[#ff9900] md:w-[250px] gap-5">
            ...
            <span className="text-[23px] font-[500]">
              {DataAnalytics_JSON.What_You_Will_Learn.Learn_Points_1}
            </span>
          </div>
          <div className="flex items-center font-[500] text-[#ff9900] md:w-[250px] gap-5">
            ...
            <span className="text-[23px] font-[500]">
              {DataAnalytics_JSON.What_You_Will_Learn.Learn_Points_2}
            </span>
          </div>
          <div className="flex items-center font-[500] text-[#ff9900] md:w-[250px] gap-5">
            ...
            <span className="text-[23px] font-[500]">
              {DataAnalytics_JSON.What_You_Will_Learn.Learn_Points_3}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className=" w-[1300px] max-w-[90%]  mx-auto grid grid-cols-1 lg:grid-cols-2 mt-20">
        <div className="flex items-center flex-col md:gap-24 gap-16 md:px-20 sm:px-10 px-5">
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3">
              <div className=" text-[16px] font-[400] text-[#212529]">
                {DataAnalytics_JSON.Learn_Process.process_1.title}
              </div>
              <div className=" text-[16px] font-[300] text-[#555555]">
                {DataAnalytics_JSON.Learn_Process.process_1.content}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3">
              <div className=" text-[16px] font-[400] text-[#212529]">
                {DataAnalytics_JSON.Learn_Process.process_2.title}
              </div>
              <div className=" text-[16px] font-[300] text-[#555555]">
                {DataAnalytics_JSON.Learn_Process.process_2.content}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3 ">
              <div className=" text-[16px] font-[400] text-[#212529]">
                {DataAnalytics_JSON.Learn_Process.process_3.title}
              </div>
              <div className=" text-[16px] font-[300] text-[#555555]">
                {DataAnalytics_JSON.Learn_Process.process_3.content}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3">
              <div className=" text-[16px] font-[400] text-[#212529]">
                {DataAnalytics_JSON.Learn_Process.process_4.title}
              </div>
              <div className=" text-[16px] font-[300] text-[#555555]">
                {DataAnalytics_JSON.Learn_Process.process_4.content}
              </div>
            </div>
          </div>
        </div>
        <div className="lg:block flex items-center justify-center">
          <img
            src={DataAnalytics_JSON.Learn_Process.Brand_Ambassedor}
            alt=""
      ...
      <div className=" max-w-screen-xl mx-auto flex items-center justify-center mt-20 flex-col gap-10">
        ...
        <div className=" text-center font-[600] text-[28px] text-[#212529] mt-14">
          {DataAnalytics_JSON.Skill_title}
        </div>
        <div className="grid md:grid-cols-5 sm:grid-cols-3 grid-cols-3 items-center justify-center gap-5 px-10">
          {DataAnalytics_JSON.Skill_Images.map((target, index) => (
            <img
              key={index}
              src={target}
              alt={`image_${index}`}
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-10 mt-16 px-5 xl:w-[1000px] md:w-[700px] w-[80%] ">
          {DataAnalytics_JSON.Week_Plans.map((target, index) => (
            <div
              key={index}
      ...
      <div className="">
        <div className="text-[28px] font-[600] text-[#212529] text-center my-20">
          {DataAnalytics_JSON.progarm_title}
        </div>
        <div className=" mt-10 px-10 w-[1200px] max-w-full mx-auto grid items-center justify-center text-center xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 lg:gap-10 md:gap-7 gap-5 ">
          {DataAnalytics_JSON.program_content.map((target, index) => (
            <div
              key={index}
        ...
        <div className="flex flex-col gap-10 mt-20">
          <div className="text-center text-[#555555] text-[16px] font-[300]">
            {DataAnalytics_JSON.apply_title}
          </div>
      ...
      <div className="mt-5 px-5">
        <div className="text-center font-[600] text-[28px] text-[#212529]">
          {DataAnalytics_JSON.certificate_page.title_1}
        </div>
        <div className="text-center font-[400] text-[18px] text-[#212529]">
          {DataAnalytics_JSON.certificate_page.title_2}
        </div>
        <div className="grid lg:grid-cols-2 grid-cols-1  xl:w-[1200px]  mx-auto gap-8 my-20 md:px-14 px-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="">
                <div className="text-[#f3274f] text-[25px] font-[400]">
                  {DataAnalytics_JSON.certificate_page.left_side.pink_title_1}
                </div>
                <div className="text-[#555555] text-[16px] font-[300] mt-4">
                  {DataAnalytics_JSON.certificate_page.left_side.content_1}
                </div>
              </div>
            </div>
            <div className="flex items-start gap-5">
              ...
              <div className="">
                <div className="text-[#f3274f] text-[25px] font-[400]">
                  {DataAnalytics_JSON.certificate_page.left_side.pink_title_2}
                </div>
                <div className="text-[#555555] text-[16px] font-[300] mt-4">
                  {DataAnalytics_JSON.certificate_page.left_side.content_2}
                </div>
              </div>
            </div>
            <div className="flex items-start gap-5">
              ...
              <div className="">
                <div className="text-[#f3274f] text-[25px] font-[400]">
                  {DataAnalytics_JSON.certificate_page.left_side.pink_title_3}
                </div>
                <div className="text-[#555555] text-[16px] font-[300] mt-4">
                  {DataAnalytics_JSON.certificate_page.left_side.content_3}
                </div>
              </div>
            </div>
          </div>
          <div className="">
            <img
              src={DataAnalytics_JSON.certificate_page.right}
              alt=""
              className="w-[full]"
            />
          </div>
