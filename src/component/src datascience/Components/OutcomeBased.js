...
import JsonCardData from "../../LearningHubPage/learninghubdev.json";
...
const OutcomeBased = () => {
  ...
  return (
    <>
      <div className="container rounded-md max-w-7xl mx-auto  pb-8 px-8">
        <div className="flex justify-center items-center">
          <h1 className="text-[32px] font-[700] mb-4 text-center inline-block">
            {Outcome.Title}
          </h1>
        </div>
