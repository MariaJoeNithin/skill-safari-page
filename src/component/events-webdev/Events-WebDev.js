...
import WebDevEvents from "./Events-WebDev.json";
...
import FAQ from "./FAQ";
import CountdownTimer from "../E_BuildPortfolio";
        ...
        <div className="col flex items-center flex-col md:gap-24 gap-16 px-5 mt-20">
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className=" text-[16px] font-[300] text-[#555555]">
                {webd.Learn_Process.process_1.content}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className=" text-[16px] font-[300] text-[#555555]">
                {webd.Learn_Process.process_2.content}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3 ">
              ...
              <div className=" text-[16px] font-[300] text-[#555555]">
                {webd.Learn_Process.process_3.content}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className=" text-[16px] font-[300] text-[#555555]">
                {webd.Learn_Process.process_4.content}
              </div>
            </div>
          </div>
        </div>
